  ...
  <div class="dashboard-panel">
    ...
    <form class="form-main" action="#" method="post">
      ...
      <div class="flex f-between v-center">
        <h1 class="title-main item mb-1">Видалити категорію: {{ $requested[0]->title }}</h1>
        <div class="btn-group item mb-1">
          <button type="submit" name="submit" class="btn btn-main alert">Так</button>
        </div>
          <p class="full">Будьте уважні! Після видалення цієї категорії ви не зможете повернути дані. Ця операція є невідворотною!</p>
      </div>
