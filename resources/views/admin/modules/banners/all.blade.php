        ...
        <div class="dashboard-panel">
            <form class="form-main" action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="flex f-between v-center">
                    <h1 class="title-main item mb-1">Cтворити баннер</h1>
                ...
                <div class="flex">
                    <div class="one-of-three">
                        ...
                        <fieldset>
                            ...
                            <input type="text" name="text" value="{{ request()->input('text', old('text')) }}">
                            @error('text')
                            <p class="notice mb-1 full error"> {{ $message }} </p>
                            @enderror
                        </fieldset>
                    ...
                    <div class="two-of-three">
                        <fieldset>
                            <label class="label">Зображення (ліворуч)</label>
                            <input type="file" name="left">
                        </fieldset>
                        <fieldset>
                            <label class="label">Зображення (праворуч)</label>
